...
(function(window, $, undefined) {
	...
	$.Cassette.prototype = {
		...
		_createControls: function() {
			...
			this.$cPlay = $('<li class="vc-control-play">开始<span></span></li>');         //Play
			this.$cRewind = $('<li class="vc-control-rewind">快退<span></span></li>');     //Rew
			this.$cForward = $('<li class="vc-control-fforward">快进<span></span></li>');  //FF
			this.$cStop = $('<li class="vc-control-stop">停止<span></span></li>');         //Stop
			this.$cSwitch = $('<li class="vc-control-switch">旋转<span></span></li>');  //Switch
